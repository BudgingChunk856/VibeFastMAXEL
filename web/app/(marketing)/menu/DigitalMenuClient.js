        ...
        <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-2xl text-base leading-7 text-base-content/65 sm:text-lg">
              Explora el menú de Los Carnales, conoce qué incluye cada producto y arma tu pedido desde el celular.
            </p>
          </div>
        </div>
      </section>
                    ...
                    <div className="mt-4 rounded-2xl bg-base-200/70 p-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {product.ingredients.map((ingredient) => (
                          <span
                            key={ingredient}
                            className="rounded-full border border-base-300 bg-base-100 px-3 py-1 text-xs font-semibold text-base-content/75"
                          >
                            {ingredient}
                          </span>
                        ))}
